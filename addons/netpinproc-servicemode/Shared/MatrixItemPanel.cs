...
/// <summary>This panel belongs to the scene MatrixItemPanel.<para/>
/// This is to display a machine item with Name, Number and wire colors. <para/>
/// When in a switch matrix or similar then the background can be changed to show pushed switches on screen.
/// </summary>
public partial class MatrixItemPanel : Panel
{
	...
	public void SetNameFromLabel(string name) =>
        _nameLbl.Text = name;

    public void SetNum(int num) => _numLbl.Text = num.ToString();

	/// <summary>Overrides the current themes panel styleBoxFlat BG Color</summary>
